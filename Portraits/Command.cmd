...
trigger2= (stateno=[200,255]) && random<ifelse(movehit,100,50)
trigger3= stateno=52 && prevstateno=226 && random<300
...
triggerall= (enemynear,const(size.head.pos.y)<=-40) || (enemynear,statetype=A)
trigger1= ctrl && (p2bodydist x=[0,90]) && (p2dist y=[-5,5]) && random<300
trigger2= ctrl && (p2stateno=[120,155]) && p2statetype!=A && random<300
